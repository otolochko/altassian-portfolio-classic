    ...
    <section id="about" className="py-24">
      <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-6 bg-white dark:bg-zinc-800/80 rounded-2xl border border-ink-200/70 dark:border-zinc-700 text-center shadow-[0_16px_40px_-30px_rgba(15,23,42,0.4)] reveal-item">
