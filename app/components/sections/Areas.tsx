...
const Areas = ({ areas }: AreasProps) => {
  return (
    <section id="areas" className="py-24 bg-zinc-50/70 dark:bg-zinc-950/40">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {areas.items.map((area, idx) => (
            <div
              key={idx}
              className="bg-white/90 dark:bg-zinc-900/90 p-6 rounded-2xl shadow-[0_18px_50px_-40px_rgba(15,23,42,0.5)] border border-zinc-300 dark:border-zinc-700 hover:shadow-[0_24px_60px_-40px_rgba(8,145,178,0.6)] transition reveal-item"
